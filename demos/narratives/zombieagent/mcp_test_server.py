...
Run standalone:
    python demos/narratives/zombieagent/mcp_test_server.py

Use with safe-mcp-proxy:
    python -m safe_mcp_proxy.mcp_server \\
        --world zombieagent_default \\
        --upstream python demos/narratives/zombieagent/mcp_test_server.py

NOTE: demo.py uses the Python executor API directly rather than this server.
